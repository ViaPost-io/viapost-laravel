...
> Próxima major `0.4.x`: migre de Laravel 11 para Laravel 12 antes de atualizar e consulte o
> changelog para as mudanças incompatíveis.
...
composer require viapost/laravel-sdk:^0.4
```
